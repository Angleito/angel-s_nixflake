...
if ! command -v darwin-rebuild &> /dev/null; then
    ...
    echo "  - Install all specified applications (Warp, Cursor, Brave, Orbstack, Zoom, Slack)"
    echo "  - Install GarageBand from Mac App Store"
    echo "  - Install Xcode Command Line Tools (if not already installed)"
    ...
    echo "  - Install Claude Code CLI, Sui CLI, and Walrus CLI (configured for testnet)"
    echo "  - Configure power management to prevent display sleep"
    echo ""
